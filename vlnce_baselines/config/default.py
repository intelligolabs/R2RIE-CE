...
# config for wandb
_C.MODEL.WANDB = CN()
_C.MODEL.WANDB.use = False
_C.MODEL.WANDB.run_name = "Train"
_C.MODEL.WANDB.notes = "Not Available"


_C.MODEL.VERBOSE = CN()
_C.MODEL.VERBOSE.IS_VERBOSE = False

_C.MODEL.TRAIN_TRAJECTORY_MATCHING = CN()
_C.MODEL.TRAIN_TRAJECTORY_MATCHING.train = False

_C.MODEL.USE_GT_TRAJECTORY = CN()
_C.MODEL.USE_GT_TRAJECTORY.use = False
