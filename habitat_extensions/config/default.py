...
# -----------------------------------------------------------------------------
# HANDLING INFORMATION ABOUT THE ERRORS INTRODUCED
# -----------------------------------------------------------------------------
_C.TASK.ERROR_INFORMATION_SENSOR_CONTAINS_ERROR = CN()
_C.TASK.ERROR_INFORMATION_SENSOR_CONTAINS_ERROR.TYPE = "ErrorSensorContainsError"
_C.TASK.ERROR_INFORMATION_SENSOR_CONTAINS_ERROR_UUID = "error_sensor_contains_error"

_C.TASK.ERROR_INFORMATION_SENSOR_ERROR_TYPE = CN()
_C.TASK.ERROR_INFORMATION_SENSOR_ERROR_TYPE.TYPE = "ErrorSensorErrorType"
_C.TASK.ERROR_INFORMATION_SENSOR_ERROR_TYPE_UUID = "error_sensor_error_type"

_C.TASK.ERROR_INFORMATION_SENSOR_TOKEN_SWAPPED_ERROR = CN()
_C.TASK.ERROR_INFORMATION_SENSOR_TOKEN_SWAPPED_ERROR.TYPE = "ErrorSensorTokenSwappedError"
_C.TASK.EERROR_INFORMATION_SENSOR_TOKEN_SWAPPED_ERROR_UUID = "error_sensor_token_swapped_error"

_C.TASK.EPISODE_ID_SENSOR = CN()
_C.TASK.EPISODE_ID_SENSOR_UUID = "episode_id_UUID"
